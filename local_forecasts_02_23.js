...
function read_api_baker(location,param,unit,forecasts_div,button_option=false){
   ...
   var file_url = "https://www.noussair.com/get_data.php?type=apibaker&st="+location+"&param=1"
