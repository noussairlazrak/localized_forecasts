                ...
                success: function() { 
                    d3.json(file_url, function(error, data) {
                        ...
                        if(data){
                            ...
                            $('.plot_additional_features').prepend('<button type="button" class="btn btn-outline-primary change_plot" change_to="main_plot_'+historical+'" href="#"> Forecast '+historical+' data</button><button type="button" change_to="resample_main_plot_'+historical+'" change_to ="resample_main_plot_'+historical+'" class="btn btn-outline-primary change_plot change_plot resample'+'_'+historical+'" href="#">'+historical+' Forecast '+resample_window+'H rolling averages</button>');

                            $('.plot_additional_features').append('<button type="button" class="btn btn-outline-primary download_forecats_data" href="#">Download the '+historical+' data');
