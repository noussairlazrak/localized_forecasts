                ...
                success: function() { 
                    d3.json(file_url, function(error, data) {
                        ...
                        if(data){
                            ...
                            $('.lf-operations').append('| <a class="download_forecats_data" href="#">Download the '+historical+' data</a>');

                            $('.lf-operations').prepend('| <a class="change_plot" change_to ="main_plot_'+historical+'" href="#"> Raw '+historical+' data</a> | <a change_to ="resample_main_plot_'+historical+'" class=" change_plot resample_'+'_'+historical+'" href="#">'+historical+' '+resample_window+'H Rolling averages</a> ');
